      ...
      <section className="border-b border-line bg-porcelain">
        <div className="mx-auto grid max-w-[1440px] lg:grid-cols-[0.82fr_1.18fr]">
          <div className="flex flex-col justify-center px-5 py-16 sm:px-8 sm:py-20 lg:px-12 lg:py-28">
            ...
            <a href={getWhatsAppLink(`Olá, gostaria de solicitar um orçamento para ${label.toLowerCase()}.`)} target="_blank" rel="noopener noreferrer" className="interactive-lift mt-9 inline-flex min-h-12 w-fit items-center gap-3 bg-caramel px-6 text-sm font-semibold text-white">
