...
const pageTitles: Record<string, string> = {
  ...
  "/camas": "Camas sob medida | Aconche Decor",
  "/cabeceiras": "Cabeceiras sob medida | Aconche Decor",
  "/puffs-e-banquetas": "Puffs e banquetas | Aconche Decor",
  "/projetos": "Projetos realizados | Aconche Decor",
  "/qualidade": "Qualidade e processo | Aconche Decor",
