  ...
  return (
    <section id="sobre" className="bg-linen py-20 sm:py-28">
      <div className="mx-auto grid max-w-[1440px] gap-12 px-5 sm:px-8 lg:grid-cols-[1.1fr_0.9fr] lg:px-12">
        <figure className="image-wash min-h-[460px]"><img src="/images/real/detalhe-painel-estofado.jpeg" alt="Detalhe de painel estofado instalado em um quarto" className="h-full w-full object-cover" /><figcaption className="absolute bottom-4 left-4 z-10 bg-[#f5f0e9]/90 px-3 py-2 text-[0.58rem] uppercase tracking-[0.12em] text-[#302720]">Detalhe de acabamento</figcaption></figure>
