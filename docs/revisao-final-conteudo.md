...
3. Guardar a autorização junto ao nome do arquivo e à data de publicação.
4. Substituir a indicação “Imagem ilustrativa” somente quando a fotografia representar um trabalho real autorizado da Aconche Decor.
